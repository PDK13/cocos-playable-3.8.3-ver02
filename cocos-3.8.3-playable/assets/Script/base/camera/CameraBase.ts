...
export default class CameraBase extends Component {
    ...
    protected onLoad() {
        director.on(BaseConstant.CAMERA_TARGET_SWITCH, this.onTargetSwitch, this);
        director.on(BaseConstant.CAMERA_TARGET_SWITCH, this.onTargetSwitchTween, this);
        director.on(BaseConstant.CAMERA_VALUE_SMOOTH_TIME, this.onValueSmoothTime, this);
        director.on(BaseConstant.CAMERA_VALUE_OFFSET, this.onValueOffset, this);
        director.on(BaseConstant.CAMERA_VALUE_SCALE, this.onValueScale, this);
        director.on(BaseConstant.CAMERA_EFFECT_SHAKE, this.onShake, this);
        director.on(BaseConstant.CAMERA_EFFECT_SHAKE_ONCE, this.onShakeOnce, this);

        director.on(BaseConstant.PLAYER_X4, this.onShake, this);
        //
